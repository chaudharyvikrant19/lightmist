...
if(!function_exists('azurahtml_sc')) {
	...
	function azurahtml_sc( $atts, $content="" ){
	    ...
	    $htmlstyle = AzuraShortcode::buildStyle($atts);

	    $animation_data = AzuraShortcode::buildAnimation($atts,'animate');

	    $shortcodeTemp = AzuraShortcode::getTemplate( $atts, $content ,'azurahtml');
...
if(!function_exists('azuratext_sc')) {
	...
	function azuratext_sc( $atts, $content="" ){
	    ...
	    $shortcodeTemp = AzuraShortcode::getTemplate( $atts, $content ,'azuratext');
...
if(!function_exists('azuratinymce_sc')) {
	...
	function azuratinymce_sc( $atts, $content="" ){
	    ...
	    $tinymcestyle = AzuraShortcode::buildStyle($atts);

	    $animation_data = AzuraShortcode::buildAnimation($atts,'animate');

	    $shortcodeTemp = AzuraShortcode::getTemplate( $atts, $content ,'azuratinymce');
