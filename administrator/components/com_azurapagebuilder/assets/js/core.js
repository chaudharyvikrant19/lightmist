...
jQuery(function($) {
    ...
    $("#azp_open_global_edit").click(function(){
        if($("#azp_global_edit").css('right') == '0px'){
            $("#azp_global_edit").animate({right:-302});
        }else{
    ...
    jQuery('body').on('hide.bs.azuramodal','#azuraPagebuilderModalElement',function(){
        $eleContainer.mixItUp('destroy', true);
    });
    ...
    jQuery('body').on('click','.add-container', function(event) {
        ...
        jQuery('.current-adding-element').removeClass('current-adding-element');
        jQuery(this).closest('.column-parent').addClass('current-adding-element');
        jQuery('#azuraPagebuilderModalColElement').azuramodal('show');
        $eleContainer.mixItUp();
    ...
    jQuery('body').on('click','.azura-elements > .azura-element', function(event){
        ...
        if($ele.is('.pagesection')){
            ...
            if(jQuery('.current-adding-element').is('.iscontainer')){
                ...
                if($ele.is('.iscontainer')){
                    jQuery('.column-parent.current-adding-element').children('.column-wrapper').children('.column').append(containerEleHtml());
                }else if($ele.is('.isrowinner')){
                    jQuery('.column-parent.current-adding-element').children('.column-wrapper').children('.column').append(rowInnerEleHtml());
                }else{
        ...
        jQuery('#azuraPagebuilderModalColElement').azuramodal('hide');
    ...
    function addSortable(){
        ...
        jQuery('.row-element.isrowinner').find('>.row').rowEleSortable();
    ...
    function rowEleHtml(){
        var itemHtml = '<div class="azura-element-block row-element pagebuilder-section isrow" data-typeName="AzuraRow">';
            itemHtml += '<div class="section-header clearfix">';
                ...
                itemHtml += '<div class="azura-element-tools pull-right">';
                    itemHtml += '<a href="javascript:void(0)" class="sec-to-templates"><i class="fa fa-download"></i> Save to templates</a>';
                    itemHtml += '<a href="javascript:void(0)" class="row-showhide"><i class="fa fa-chevron-up"></i></a>';
                    itemHtml += '<a href="javascript:void(0)" class="row-configs"><i class="fa fa-cog"></i></a>';
                    itemHtml += '<a  href="javascript:void(0)" class="row-duplicate"><i class="fa fa-copy"></i></a>';
                    itemHtml += '<a  href="javascript:void(0)" class="row-delete"><i class="fa fa-times"></i></a>';
    ...
    function rowInnerEleHtml(){
        var itemHtml = '<div class="azura-element-block azura-element row-element isrowinner" data-typeName="AzuraRowInner">';
            itemHtml += '<div class="section-header clearfix">';
            ...
            itemHtml += '<div class="azura-element-type-azurarow-container row">';
                ...
                itemHtml += '<div class="column-parent col-md-12" data-typeName="AzuraColumnInner">';
                    itemHtml += '<div class="column-wrapper">';
                        itemHtml += '<div class="col-settings">';
                            //itemHtml += '<a class="col-tools-name" href="javascript:void(0);">Column Tools</a>';
                            //itemHtml += '<a class="add-container" href="javascript:void(0)" title="Add Container element"><i class="fa fa-plus-circle"></i></a>';
                    ...
                    itemHtml += '<div class="azura-element-settings-saved saved" data="'+ encodeURIComponent('{"type":"AzuraColumnInner","id": "0","published":"1","language":"*", "content":"","attrs":{"columnwidthclass":"col-md-12"}}')+ '"></div>';
            ...
            /*section data */
            itemHtml += '<div class="azura-element-settings-saved saved" data="'+encodeURIComponent('{"type":"AzuraRowInner","id": "0","published":"1","language":"*", "content":"","attrs":{}}')+'"></div>';
            /*end section data */
    ...
    jQuery('body').on('click', '.row-showhide', function(event) {
        ...
        //var rowP = jQuery(this).closest('.row-element');
        var rowP = jQuery(this).closest('.azura-element-block');
    ...
    jQuery('body').on('click', '.row-add-new-col', function(event) {
        ...
        var parent = jQuery(this).closest('.row-element');
    ...
    jQuery('body').on('click', '.row-duplicate', function(event) {
        ...
        var parent = jQuery(this).closest('.azura-element-block');
    ...
    jQuery('body').on('click','.row-delete',function(event){
        ...
        if(confirmWin === true){
            var row = jQuery(this).closest('.azura-element-block');
            row.remove();
        }
    ...
    jQuery('body').on('click', '.row-configs', function(event) {
        ...
        //var parent = jQuery(this).closest('.row-element');//jQuery(this).parent().parent().parent();
        var parent = jQuery(this).closest('.azura-element-block');//jQuery(this).parent().parent().parent();
    ...
    function addColumnEle(parent, layout,restored,iscustom,isrowinner){
        if(iscustom){
        ...
        if(restored === undefined){
            restored = new Array();
            if(isrowinner){
                restored['coldata'] = encodeURIComponent('{"type":"AzuraColumnInner","id": "0","published":"1","language":"*", "content":"","attrs":{"columnwidthclass": "col-md-12"}}');
            }else{
        ...
        if(isrowinner){
        var html = '<div class="'+col_layout+' column-parent" data-typeName="AzuraColumnInner">';
        }else{
    ...
    jQuery('body').on('click', '.set-width', function(event) {
        ...
        isrowinner = jQuery(this).closest('.row-element').is('.isrowinner');

        var rowContainer = jQuery(this).closest('.row-element').children('.row');
        ...
        if(isrowinner){
            if(restored !== undefined){
                for (index = 0; index < layout.length; ++index) {
                    addColumnEle(rowContainer,layout[index],restored[index],false,true);
                }
            }
        }else{
            if(restored !== undefined){
                for (index = 0; index < layout.length; ++index) {
                    addColumnEle(rowContainer,layout[index],restored[index],false,false);
                }
            }
        }
    ...
    jQuery('body').on('click','.set-width-custom-button', function(event){
        ...
        if(isrowinner){
            if(restored !== undefined){
                for (index = 0; index < layout.length; ++index) {
                    addColumnEle(rowContainer,layout[index],restored[index],true,true);
                }
            }
        }else{
            if(restored !== undefined){
                for (index = 0; index < layout.length; ++index) {
                    addColumnEle(rowContainer,layout[index],restored[index],true,false);
                }
            }
        }
    ...
    jQuery('body').on('click', '.azura-setting-btn-save', function(event) {
        ...
        if(elementCurrentEditingType === 'AzuraColumn'||elementCurrentEditingType === 'AzuraColumnInner'){
    ...
    function genColumnsShortcodes(rowitem,row){
        var rowitem = rowitem ? rowitem : {};
        /* column elements */
        jQuery('> .row > .column-parent',row).each(function(index){
            ...
            rowitem.children[colIndex] = JSON.parse(decodeURIComponent(colData));
            rowitem.children[colIndex].children = [];
            ...
            $column.find('> .column-wrapper > .column > .azura-element').each(function(index){
                ...
                /* rowinner element */
                if($element.is('.isrowinner')){
                    rowitem.children[colIndex].children[eleIndex] = JSON.parse(decodeURIComponent(eleData));
                    rowitem.children[colIndex].children[eleIndex].children = [];

                    rowitem.children[colIndex].children[eleIndex] = genColumnsShortcodes(rowitem.children[colIndex].children[eleIndex],$element);

                    //item = genPageContentShortcodes(item[rowIndex].children[colIndex].children[eleIndex],$element.closest('.column'));

                }/* end rowinner element */
                /* container element */
                else{
                    if($element.is('.iscontainer')){
                        ...
                        $element.find('> .azura-elements-container > .azura-element').each(function(index){
                            ...
                            rowitem.children[colIndex].children[eleIndex].children[celeIndex] = JSON.parse(decodeURIComponent(celeData));
                            rowitem.children[colIndex].children[eleIndex].children[celeIndex].children = [];
                            ...
                            if($celement.find('.azura-element-children .azura-element-child')){
                                $celement.find('.azura-element-children .azura-element-child').each(function(index){
                                    ...
                                    rowitem.children[colIndex].children[eleIndex].children[celeIndex].children[childeleIndex] = JSON.parse(decodeURIComponent(childeleData));
                                    rowitem.children[colIndex].children[eleIndex].children[celeIndex].children[childeleIndex].children = [];
                                });
                            }
                        });
                    ...
                    /* end container element */
                        ...
                        if($element.find('.azura-element-children .azura-element-child')){
                            $element.find('.azura-element-children .azura-element-child').each(function(index){
                                ...
                                rowitem.children[colIndex].children[eleIndex].children[childeleIndex] = JSON.parse(decodeURIComponent(childeleData));
                                rowitem.children[colIndex].children[eleIndex].children[childeleIndex].children = [];
                            });
                        }
                    }
                }
    ...
    function genPageContentShortcodes(item,parent){
        ...
        jQuery('>.pagebuilder-section, >.row-element', parent).each(function(index) {
            ...
            /* row elements */
                ...
                item[rowIndex] = genColumnsShortcodes(item[rowIndex],$row);
                // /* column elements */
    ...
    function genSectionContentShortcodes(section){
        ...
        /* row elements */
            ...
            item = genColumnsShortcodes(item,section);
