...
$doc->addStyleSheet(JURI::base(true).'/components/com_azurapagebuilder/assets/css/content-element-reset.css');
$doc->addStyleSheet(JURI::base(true).'/components/com_azurapagebuilder/assets/css/content-element.css');
...
//customCssLinks
if($this->form->getValue('customCssLinks')){
	$doc->addStyleDeclaration($this->form->getValue('customCssLinks'));
}
...
<?php $colelements = AzuraElements::getColElements(false);
	//cats array
	//$eleCats = AzuraElements::getElementCats(); //echo'<pre>';var_dump($eleCats);die;?>
<!-- Page Elements Modal -->
<div id="azuraPagebuilderModalColElement" class="azura-modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="azura-modal-dialog azura-modal-lg">
    <div class="azura-modal-content">
     	<div class="azura-modal-header">
			<button type="button" class="close" data-dismiss="azura-modal" aria-hidden="true">×</button>
			<h3 id="myLargeModalLabel">Column Elements</h3>
		</div>

		<div class="azura-modal-body azura-elements-body">
			<div class="azura-elements clearfix">
			<?php
				foreach ($colelements as $key => $ele) {
					require(JPATH_ADMINISTRATOR.DIRECTORY_SEPARATOR.'components/com_azurapagebuilder/views/page/elementTemplate/elements.php'); 
				}
			?>
			</div>
  ...
  <div class="modal-body">
	...
	<div class="tab-content">
		<div role="tabpanel" class="tab-pane active" id="PageTemplate">
			...
			<ul id="templateList" class="nav nav-list template-list" style="height:186px;overflow:auto">
		...
		<div role="tabpanel" class="tab-pane" id="SectionTemplate">
			...
			<ul id="secTemplateList" class="nav nav-list template-list" style="height:186px;overflow:auto">
