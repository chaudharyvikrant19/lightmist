...
<div class="mix azura-element row-element pagesection <?php echo strtolower(str_replace(" ", "_", $ele->category));?> isrow" data-ele="<?php echo rawurlencode(json_encode($ele));?>">
...
<?php elseif($ele->typename === 'AzuraRowInner') :?>
<div class="mix azura-element row-element <?php echo strtolower(str_replace(" ", "_", $ele->category));?> isrowinner" data-ele="<?php echo rawurlencode(json_encode($ele));?>">
	<div class="azura-element-wrapper azura-element-type-<?php echo strtolower($ele->typename);?> clearfix">
		<img class="element-icon" src="<?php echo JURI::root(true).'/media/com_azurapagebuilder/elements-icon/'. strtolower(substr($ele->typename, 5));?>-icon.png" alt="<?php echo strtolower(substr($ele->typename, 5));?>" width="24" height="24">
		<h3><?php echo $ele->name;?></h3>
		<?php if(!empty($ele->description)) :?>
...
<?php elseif($ele->typename === 'AzuraContainer') :?>
<div class="mix azura-element <?php echo strtolower(str_replace(" ", "_", $ele->category));?> iscontainer" data-ele="<?php echo rawurlencode(json_encode($ele));?>">
	<div class="azura-element-wrapper azura-element-type-<?php echo strtolower($ele->typename);?> clearfix">
		<img class="element-icon" src="<?php echo JURI::root(true).'/media/com_azurapagebuilder/elements-icon/'. strtolower(substr($ele->typename, 5));?>-icon.png" alt="<?php echo strtolower(substr($ele->typename, 5));?>" width="24" height="24">
		<h3><?php echo $ele->name;?></h3>
		<?php if(!empty($ele->description)) :?>
