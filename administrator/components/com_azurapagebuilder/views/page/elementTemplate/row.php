...
?>
<?php if($element->type === 'AzuraRowInner') :?>
<div class="azura-element-block azura-element row-element isrowinner" data-typeName="<?php echo $element->type;?>">

<?php else : ?>
<div class="azura-element-block row-element pagebuilder-section isrow" data-typeName="<?php echo $element->type;?>">
<?php endif;?>
	...
	<div class="azura-element-type-<?php echo strtolower($element->type);?>-container row <?php //echo $element->attrs->secclass;?>"><?php
		...
		<?php if($element->type === 'AzuraRowInner') :?>
			<div class="column-parent col-md-12"  data-typeName="AzuraColumnInner">
		<?php else :?>
		...
		<?php endif;?>
			...
			<?php if($element->type === 'AzuraRowInner') :?>
				<div class="azura-element-settings-saved saved" data="<?php echo rawurlencode('{"type":"AzuraColumnInner","id": "0","published":"1","language":"*", "content":"","attrs":{"columnwidthclass":"col-md-12"}}');?>"></div>
			<?php else :?>
