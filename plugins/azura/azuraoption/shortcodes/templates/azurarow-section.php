...
<section <?php echo $id . ' ' .$classes.' '.$rowstyle.' '.$animationData;?>>
	<?php if(!empty($overlaybackground)): ?>
	<div class="image-bg content-in fixed" style="background-image:url('<?php echo $overlaybackground; ?>');"><?php if(!empty($overlayclass)): ?><div class="<?php echo $overlayclass; ?>"></div><?php endif; ?></div>
	<?php endif; ?>
