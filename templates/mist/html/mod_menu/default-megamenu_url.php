...
switch ($item->browserNav)
{
	...
	case 0:
?>
	<a <?php echo $class;?> href="<?php echo $item->flink; ?>" <?php echo $title; ?>> <?php echo $faicon.' '.$linktype.' '.$subtitle; ?></a>
	<?php if(!empty($iconclass)) echo '<i class="'.$iconclass.'"></i>';
		break;
	case 1:
		// _blank
?>
    <a <?php echo $class; ?> href="<?php echo $item->flink; ?>" target="_blank" <?php echo $title; ?>> <?php echo $faicon.' '.$linktype.' '.$subtitle; ?></a>
	<?php if(!empty($iconclass)) echo '<i class="'.$iconclass.'"></i>';
		break;
	case 2:
	// window.open
