...
<div class="page-links <?php echo $class_sfx;?>"<?php
	$tag = '';
...
foreach ($list as $i => &$item)
{
	...
	switch ($item->type) :
		...
		case 'url':
		case 'component':
			require JModuleHelper::getLayoutPath('mod_menu', 'default-megamenu_' . $item->type);
			break;
		default:
			require JModuleHelper::getLayoutPath('mod_menu', 'default-megamenu_url');
			break;
	endswitch;
