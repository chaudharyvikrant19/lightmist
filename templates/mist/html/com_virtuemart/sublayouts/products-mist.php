...
defined('_JEXEC') or die('Restricted access');die;
		...
		<div class="<?php echo $numcol; ?>">
			<div class="product-item">
                <div class="product-img">
                    ...
                    <div class="product-overlay">
                        <div class="add-to-cart">
                        	<div class="vm3pr-<?php echo $rowsHeight[$row]['customfields'] ?> dv-addtocart"> <?php
                ...
                <div class="product-details">
                    ...
                    <h5 class="text-color"><?php echo shopFunctionsF::renderVmSubLayout('prices',array('product'=>$product,'currency'=>$currency)); ?></h5>
                </div>
            </div>
			<div class="product-item">
				<figure>
					...
					<figcaption>
						...
						<a href="<?php echo JURI::root(true).'/'.$product->file_url;?>" class="zoom"><i class="fa fa-search"></i></a>
				...
				<div class="product-details">
					...
					<div>
						...
						<p class="title"><a href="<?php echo $product->link; ?>"><?php echo $product->product_name; ?></a></p>
					...
					<div class="vm-details-button">
						...
						echo "<a href=\"$link\" class=\"details\"><i class=\"fa fa-bars\"></i> ".JTEXT::_('TPL_BISS_DETAILS_TEXT')."</a>";
						//echo JHtml::link($link.$ItemidStr,vmText::_ ( 'COM_VIRTUEMART_PRODUCT_DETAILS' ), array ('title' => $product->product_name, 'class' => 'product-details-btn' ) );
