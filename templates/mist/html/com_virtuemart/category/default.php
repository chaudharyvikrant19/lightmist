...
<!-- <h1><?php echo $this->category->category_name; ?></h1>
 -->
	<?php
	$divclass = 'catview shop text-center';
	$perrow = $this->category->products_per_row;
	if($perrow == 3) $divclass = 'catview shop grid-3 text-center';
	if($perrow == 2) $divclass = 'catview shop grid-3';
	if (!empty($this->products)) {
	$products = array();
	$products[0] = $this->products;
	echo '<div class="'.$divclass.'">'.shopFunctionsF::renderVmSubLayout($this->productsLayout,array('products'=>$products,'currency'=>$this->currency,'products_per_row'=>$this->perRow,'showRating'=>$this->showRating)).'</div>';
