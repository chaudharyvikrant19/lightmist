...
<?php if(isset($this->item->author->link) && $this->item->author->link): ?>
	<div class="timeline-meta">
	    <div class="meta_details"><a href="<?php echo $this->item->author->link; ?>"><?php echo $this->item->author->name; ?></a> / <a href="<?php echo $this->item->category->link; ?>"><?php echo $this->item->category->name;?></a></div>
	</div>
<?php else: ?>
	<div class="timeline-meta">
	    <div class="meta_details"><?php echo $this->item->author->name; ?> / <?php echo $this->item->category->name;?></div>
	</div>
<?php endif; ?>

<div class="timeline-icon">
    <div class="date"><?php echo JHTML::_('date', $this->item->created, 'M'); ?>
    <span><?php echo JHTML::_('date', $this->item->created, 'd'); ?></span></div>
</div>
