...
?>
<div class="post-item post-tag">
	<?php
	switch ($postType) :
	case '1': # single photo ?>
		<?php if(!empty($extraFields[1]->value)): ?>
        <div class="post-image pull-left">
            <img src="<?php echo JURI::root(true).$extraFields[1]->value; ?>" width="300" height="282" alt="" title="" />
        </div>
    	<?php endif; ?>
    	<?php	break;
    case '2': # slider image ?>
			    	...
			    	foreach ($extraFields as $key => $field) :
				    	...
				    	<div class="item<?php if($key === 3) echo ' active'; ?>">
				    		<a href="<?php echo $this->item->link; ?>" class="image">
			                	<img src="<?php echo JURI::root(true).$field->value;?>" width="300" height="282" alt="<?php echo $this->item->title. '-image-'.($key+1);?>" title=""  class="img-responsive" />
			                </a>
			            </div>
					<?php endif; endforeach; ?>
	            </div>
    ...
    case '3': # youtube video 
    	...
    	<div class="video">
			...
			<iframe src="http://www.youtube.com/embed/<?php echo $id[1];?>" style="border:0;width:100%; height:200px;"></iframe>
    ...
    case '4': # vimeo video 
		...
		<div class="video">
			...
			<iframe src="http://player.vimeo.com/video/<?php echo $id[1];?>" style="border:0; width:100%; height:200px;"></iframe>
	...
	case '5': # soundcloud audio 
		...
		<div class="audio">
			...
			<iframe  style="border:0;width:100%; height:166;" src="https://w.soundcloud.com/player/?url=<?php echo $url;?>"></iframe>
    ...
    <div class="post-meta">
        <!-- Author  -->
	  	<a href="#">
	  		<span class="author"><i class="fa fa-user"></i> <?php echo ElementParser::userGetName($this->item->created_by); ?></span>
        </a> 
