...
?>
<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form" role="form" class="form-inline">
	...
	<div class="userdata">
		...
		<div id="form-login-password" class="form-group">
			<div class="input-group">
				...
				<?php else: ?>
					<label for="modlgn-passwd" class="label-control"><?php echo JText::_('JGLOBAL_PASSWORD') ?></label>
					<input id="modlgn-passwd" type="password" name="password" class="input-small form-control" tabindex="0" size="18" placeholder="<?php echo JText::_('JGLOBAL_PASSWORD') ?>" />
				<?php endif; ?>
			</div>
		</div>
		...
		<div id="form-login-remember" class="form-group checkbox" style="margin: 10px 0px;">
			<label for="modlgn-remember" class="control-label checkbox"><?php echo JText::_('MOD_LOGIN_REMEMBER_ME') ?></label> <input id="modlgn-remember" type="checkbox" name="remember" class="inputbox" value="yes"/>
		</div>
		<?php endif; ?>
		<div class="clearfix"></div>
