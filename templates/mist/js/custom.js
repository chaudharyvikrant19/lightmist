...
var appMaster = {
	...
	/* --------------------- */
	parallaxBg: function(){	
		if($('.content-in').length != 0 && !navigator.userAgent.match(/iPad|iPhone|Android/i)){	
			$('.content-in').parallax("50%", 0.5);
		}
		if($('.content-in-pagetitle').length != 0 && !navigator.userAgent.match(/iPad|iPhone|Android/i)){	
			$('.content-in-pagetitle').parallax("50%", -0.5);
		}
    },
	/* ---------------------	
		Portfolio
	...
	setupMega: function(){
		if($('.mega-menu-pos-1').length > 0){
			$('.mega-1').contents().appendTo('.mega-menu-pos-1');
			$('.mega-1').remove();
		}
		if($('.mega-menu-pos-2').length > 0){
			$('.mega-2').contents().appendTo('.mega-menu-pos-2');
			$('.mega-2').remove();
		}
		if($('.mega-menu-pos-3').length > 0){
			$('.mega-3').contents().appendTo('.mega-menu-pos-3');
			$('.mega-3').remove();
		}
		if($('.mega-menu-pos-4').length > 0){
			$('.mega-4').contents().appendTo('.mega-menu-pos-4');
			$('.mega-4').remove();
		}
		if($('.mega-menu-pos-5').length > 0){
			$('.mega-5').contents().appendTo('.mega-menu-pos-5');
			$('.mega-5').remove();
		}
	},
...
function GmapInit() {
    if($('.map-canvas').length) {
	  ...
	  Gmap.each(function() {
		...
		var image = '/mist/images/img/map-marker.png';
