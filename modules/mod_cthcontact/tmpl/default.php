...
<div class="cthcontact_contactform contact-form <?php echo $moduleclass_sfx; ?>">
    ...
    <form action="<?php echo JURI::root();?>" method="post" role="form" name="cthcontactform">
        ...
        <div class="textarea-message form-group">
            <textarea name="message" class="textarea-message form-control" placeholder="<?php echo JText::_('TPL_MIST_YOUR_MESSAGE_TEXT');?>" rows="4" ></textarea>
        </div>
        ...
        <button type="submit" class="cthsubmit btn btn-default" ><?php echo JText::_('TPL_MIST_SEND_MESSAGE_TEXT');?><i class="icon-paper-plane"></i></button>
