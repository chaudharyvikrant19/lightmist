...
<div  class="page-header page-title-left <?php echo $moduleclass_sfx; ?>">
	<div class="image-bg content-in content-in-pagetitle" style="background-image:url('<?php echo $bgimage; ?>'); background-position: 50% 0;" data-stellar-background-ratio="0.5"></div>
